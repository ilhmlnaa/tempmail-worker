...
export function DashboardPage({
  ...
  const baseUrl = apiKeyFilter ? `/legacy/admin/apikeys/${apiKeyFilter.id}` : '/legacy/admin'
  ...
  return Layout({
    ...
    <div class="dash-header">
      ...
      ${apiKeyFilter ? html`
        <a href="/legacy/dashboard" class="btn-primary" style="text-decoration:none"><i data-lucide="arrow-left" class="icon-inline" style="color:white;margin:0 8px 0 0"></i> Back to Dashboard</a>
      ` : html`
      ...
      <div class="inbox-list">
        ...
        ${apiKeys && apiKeys.map(k => html`
          <div class="inbox-item" id="keyrow-${k.id}">
            ...
            <div class="actions">
              <a href="/legacy/admin/apikeys/${k.id}" class="btn-icon" title="View Generated Inboxes"><i data-lucide="eye"></i></a>
    ...
    ${Panel({ title: 'Inbox Management', icon: 'inbox', children: html`
      ...
      <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; margin-top:24px; padding-top:16px; border-top:1px solid var(--border)">
        ...
        <a href="/legacy/admin/inboxes" class="btn-primary" style="text-decoration:none">
    ...
    <script>
      ...
      async function delKey(id) {
        confirmAction('Revoke API Key', 'Are you sure you want to revoke this API Key? Applications using it will immediately lose access.', 'Revoke Key', async function() {
          const r = await fetch('/legacy/admin/apikeys/' + encodeURIComponent(id), { method: 'DELETE' });
          if (r.ok) {
